@php
    ...
    // Logika: Cari timesheet yang statusnya 'submitted' DAN pemiliknya adalah bawahan saya
    $user = Auth::user();
    $subordinateIds = $user->subordinates()->pluck('user_id'); // Ambil ID semua bawahan

    $pendingApprovals = Timesheet::where('status', 'submitted')
        ->whereIn('user_id', $subordinateIds) // Filter hanya punya bawahan
        ->count();
    ...
    $totalStaff = User::whereIn('user_id', $subordinateIds)->count();
@endphp

<x-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800 dark:text-gray-200 leading-tight z-50 ">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-md font-medium text-gray-500 dark:text-gray-400">Approved (This Week)</p>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-md font-medium text-gray-500 dark:text-gray-400">Total Subordinate</p>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">
                ...
                <div class="lg:col-span-2">
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <a href="{{ route('timesheet.index') }}"
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-900 dark:text-white">Review & Approve</p>
                                        <p class="text-xs max-sm:text-sm text-gray-500">Check submitted timesheets</p>
                                    </div>
                                </a>
                                ...
                                <a href="{{ route('report.monthly') }}"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs max-sm:text-sm text-gray-500">View team performance summary</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="text-lg text-indigo-100 font-bold mb-1">Good Day, Manager!</h3>
                                <p class="text-sl text-sm text-indigo-100">
                                    Anda memiliki <strong>{{ $pendingApprovals }} timesheet</strong> yang menunggu
                                    persetujuan minggu ini. Mohon ditinjau sebelum hari Jumat.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 z-10">
                        <div class="flex justify-between items-start mb-6">
                            <div class="flex items-center space-x-2 ">
                                ...
                                <span class="text-xs tracking-widest uppercase font-semibold text-yellow-400">Manager
                                    Access</span>
                            </div>
                            <span
                                class="px-2 py-1 bg-yellow-500/20 text-yellow-400 text-[10px] font-bold rounded border border-yellow-500/30">
                                AUTHORIZED
                            </span>
                        </div>
                        ...
                        <div class="flex items-center space-x-4 mb-6">
                            <div
                                class="w-16 h-16 rounded-full bg-gradient-to-r from-yellow-500 to-orange-600 flex items-center justify-center text-xl font-bold dark:text-slate-900 text-white shadow-lg border-2 border-slate-100 dark:border-slate-700">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-yellow-500 mt-1 uppercase tracking-wide font-semibold">
                        ...
                        <div class="grid grid-cols-2 gap-4 border-t border-slate-700/50 pt-4">
                            <div>
                                ...
                                <p class="font-mono text-sm tracking-wider text-gray-900 dark:text-white">{{ Auth::user()->user_id }}
                                </p>
                            </div>
                            <div>
