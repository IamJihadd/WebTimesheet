                ...
                <div class="lg:col-span-2">
                    ...
                    <div
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="text-lg font-bold mb-1">Good Day, Manager!</h3>
                ...
                <div
                    ...
                    <div class="p-6 z-10">
                        ...
                        <div class="flex items-center space-x-4 mb-6">
                            <div
                                class="w-16 h-16 rounded-full bg-gradient-to-r from-yellow-500 to-orange-600 flex items-center justify-center text-xl font-bold text-white shadow-lg border-2 border-slate-700">
