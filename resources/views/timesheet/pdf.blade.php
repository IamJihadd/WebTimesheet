...
<body>
    ...
    <div class="info-section">
        <div class="info-row">
            <div class="info-label">WBS MASTER</div>
            <div class="info-value"></div>{{-- untuk memanggil WBS nya apa --}}
    ...
    <table class="timesheet-table">
        <thead>
            <tr>
                <th rowspan="3" style="min-width: 60px;">Discipline</th>
                <th rowspan="3" style="min-width: 60px;">Level Grade</th>
                <th rowspan="3" style="min-width: 80px;">Project Code</th>
                <th rowspan="3" style="min-width: 50px;">Cost Code</th>
                <th rowspan="3" style="min-width: 80px;">Task</th>
    ...
    <div class="signature-section">
        <div class="signature-box">
            ...
            <div class="signature-line">Date : {{ $timesheet->submitted_at ? $timesheet->submitted_at->format('d M Y') : '' }}</div>
        ...
        <div class="signature-box">
            ...
            <div class="signature-line">Date : {{ $timesheet->approved_at ? $timesheet->approved_at->format('d M Y') : '' }}</div>
            <div class="signature-line">Signature : ________________________</div>
        </div>
    </div>
